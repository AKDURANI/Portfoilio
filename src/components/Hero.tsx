...
const Hero = () => {
  ...
  const roles = ['AI Engineer', 'ML Specialist', 'Cloud Developer', 'CS Graduate'];
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
            Computer Science graduate specializing in Artificial Intelligence. I build intelligent systems, 
            from VR platforms to neural networks, transforming complex problems into elegant solutions.
          </p>
